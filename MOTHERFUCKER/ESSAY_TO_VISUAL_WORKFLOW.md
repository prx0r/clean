...
> Version 1 background. For new work, the normative workflow is `VISUAL_DECISION_PROTOCOL.md`. It adds a visual-free argument IR, typed source units, relation/mechanism compatibility, three-candidate scoring, continuity lifecycles, visual-only diagram handling, and correspondence auditing.
