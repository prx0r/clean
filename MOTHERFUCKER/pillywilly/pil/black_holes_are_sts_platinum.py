#!/usr/bin/env python3
"""BLACK HOLES ARE THE PATH TO TOTAL NONEXISTENCE
And That Balances God — Cassiopaean Cosmology"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_black_holes_are_sts")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Black holes are grand-scale STS","And That Balances God — Cassiopaean Cosmology")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Inward to total nonexistence","And That Balances God — Cassiopaean Cosmology")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Nonexistence balances total existence","And That Balances God — Cassiopaean Cosmology")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Total existence is God","And That Balances God — Cassiopaean Cosmology")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"STS as gravitational collapse","And That Balances God — Cassiopaean Cosmology")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The black sun tradition","And That Balances God — Cassiopaean Cosmology")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Consciousness consuming itself","And That Balances God — Cassiopaean Cosmology")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Hawking radiation as balance","And That Balances God — Cassiopaean Cosmology")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"STO expands — STS contracts","And That Balances God — Cassiopaean Cosmology")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Which path are you on?","And That Balances God — Cassiopaean Cosmology")
...
SCENES=[ Scene("Black holes are grand-scale STS","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v0",{}), Scene("Inward to total nonexistence","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v1",{}), Scene("Nonexistence balances total existence","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v2",{}), Scene("Total existence is God","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v3",{}), Scene("STS as gravitational collapse","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v4",{}), Scene("The black sun tradition","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v5",{}), Scene("Consciousness consuming itself","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v6",{}), Scene("Hawking radiation as balance","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v7",{}), Scene("STO expands — STS contracts","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v8",{}), Scene("Which path are you on?","And That Balances God — Cassiopaean Cosmology",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"black_holes_are_sts.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"black_holes_are_sts","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
