...
Light as the Substance of Being"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_suhrawardi_illumination")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Shihab al-Din Suhrawardi","Light as the Substance of Being")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The philosophy of illumination (ishraq)","Light as the Substance of Being")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Light is not a metaphor — it is being","Light as the Substance of Being")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The hierarchy of lights","Light as the Substance of Being")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Light of lights: the source","Light as the Substance of Being")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The darkness of matter","Light as the Substance of Being")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The imaginal world and Hurqalya","Light as the Substance of Being")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Corbin's rediscovery","Light as the Substance of Being")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Suhrawardi's influence on Sufism","Light as the Substance of Being")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The practice of illumination","Light as the Substance of Being")
...
SCENES = [ Scene("Shihab al-Din Suhrawardi","Light as the Substance of Being",7.0,"vis_v0",{}), Scene("The philosophy of illumination (ishraq)","Light as the Substance of Being",7.0,"vis_v1",{}), Scene("Light is not a metaphor — it is being","Light as the Substance of Being",7.0,"vis_v2",{}), Scene("The hierarchy of lights","Light as the Substance of Being",7.0,"vis_v3",{}), Scene("Light of lights: the source","Light as the Substance of Being",7.0,"vis_v4",{}), Scene("The darkness of matter","Light as the Substance of Being",7.0,"vis_v5",{}), Scene("The imaginal world and Hurqalya","Light as the Substance of Being",7.0,"vis_v6",{}), Scene("Corbin's rediscovery","Light as the Substance of Being",7.0,"vis_v7",{}), Scene("Suhrawardi's influence on Sufism","Light as the Substance of Being",7.0,"vis_v8",{}), Scene("The practice of illumination","Light as the Substance of Being",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"suhrawardi_illumination.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"suhrawardi_illumination","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
