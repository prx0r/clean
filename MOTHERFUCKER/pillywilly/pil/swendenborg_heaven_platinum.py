#!/usr/bin/env python3
"""SWEDENBORG'S HEAVENLY CORRESPONDENCES
Everything Physical Reflects the Spiritual"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_swendenborg_heaven")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Emanuel Swedenborg: scientist turned seer","Everything Physical Reflects the Spiritual")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Correspondence: the physical reflects the spiritual","Everything Physical Reflects the Spiritual")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Heaven and Hell: the geography of the soul","Everything Physical Reflects the Spiritual")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The spiritual world is a world of causes","Everything Physical Reflects the Spiritual")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Angels are humans perfected","Everything Physical Reflects the Spiritual")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Judgment after death is self-judgment","Everything Physical Reflects the Spiritual")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Swedenborg meets the Bardo Thodol","Everything Physical Reflects the Spiritual")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Correspondence and the Tantraloka","Everything Physical Reflects the Spiritual")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The universal human: Adam Kadmon","Everything Physical Reflects the Spiritual")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Heaven is a state of love","Everything Physical Reflects the Spiritual")
...
SCENES = [ Scene("Emanuel Swedenborg: scientist turned seer","Everything Physical Reflects the Spiritual",7.0,"vis_v0",{}), Scene("Correspondence: the physical reflects the spiritual","Everything Physical Reflects the Spiritual",7.0,"vis_v1",{}), Scene("Heaven and Hell: the geography of the soul","Everything Physical Reflects the Spiritual",7.0,"vis_v2",{}), Scene("The spiritual world is a world of causes","Everything Physical Reflects the Spiritual",7.0,"vis_v3",{}), Scene("Angels are humans perfected","Everything Physical Reflects the Spiritual",7.0,"vis_v4",{}), Scene("Judgment after death is self-judgment","Everything Physical Reflects the Spiritual",7.0,"vis_v5",{}), Scene("Swedenborg meets the Bardo Thodol","Everything Physical Reflects the Spiritual",7.0,"vis_v6",{}), Scene("Correspondence and the Tantraloka","Everything Physical Reflects the Spiritual",7.0,"vis_v7",{}), Scene("The universal human: Adam Kadmon","Everything Physical Reflects the Spiritual",7.0,"vis_v8",{}), Scene("Heaven is a state of love","Everything Physical Reflects the Spiritual",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"swendenborg_heaven.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"swendenborg_heaven","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
