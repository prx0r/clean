#!/usr/bin/env python3
"""ATALANTA FUGIENS
The Alchemical Fugue as Chakra Progression"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_atalanta_fugiens")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Michael Maier's alchemical music","The Alchemical Fugue as Chakra Progression")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"50 emblems — 50 fugues","The Alchemical Fugue as Chakra Progression")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Atalanta and Hippomenes: the race","The Alchemical Fugue as Chakra Progression")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The three golden apples","The Alchemical Fugue as Chakra Progression")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Each emblem is a stage","The Alchemical Fugue as Chakra Progression")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The music encodes the process","The Alchemical Fugue as Chakra Progression")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The chakra correspondence","The Alchemical Fugue as Chakra Progression")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The fugue as spiritual ascent","The Alchemical Fugue as Chakra Progression")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Seeing with the ears","The Alchemical Fugue as Chakra Progression")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The alchemy of sound","The Alchemical Fugue as Chakra Progression")
...
SCENES = [ Scene("Michael Maier's alchemical music","The Alchemical Fugue as Chakra Progression",7.0,"vis_v0",{}), Scene("50 emblems — 50 fugues","The Alchemical Fugue as Chakra Progression",7.0,"vis_v1",{}), Scene("Atalanta and Hippomenes: the race","The Alchemical Fugue as Chakra Progression",7.0,"vis_v2",{}), Scene("The three golden apples","The Alchemical Fugue as Chakra Progression",7.0,"vis_v3",{}), Scene("Each emblem is a stage","The Alchemical Fugue as Chakra Progression",7.0,"vis_v4",{}), Scene("The music encodes the process","The Alchemical Fugue as Chakra Progression",7.0,"vis_v5",{}), Scene("The chakra correspondence","The Alchemical Fugue as Chakra Progression",7.0,"vis_v6",{}), Scene("The fugue as spiritual ascent","The Alchemical Fugue as Chakra Progression",7.0,"vis_v7",{}), Scene("Seeing with the ears","The Alchemical Fugue as Chakra Progression",7.0,"vis_v8",{}), Scene("The alchemy of sound","The Alchemical Fugue as Chakra Progression",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"atalanta_fugiens.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"atalanta_fugiens","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
