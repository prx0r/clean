#!/usr/bin/env python3
"""HARRY POTTER AND THE ALCHEMICAL CODEX
Horcruxes as Inverse Chakras
...
FILM THESIS
-----------
A golden snitch inscribed with alchemical symbols
OUTPUT
------
output_harry_potter_alchemy/
"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_harry_potter_alchemy")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The alchemical structure of Harry Potter","Horcruxes as Inverse Chakras")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"7 Horcruxes — 7 chakras inverted","Horcruxes as Inverse Chakras")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Deathly Hallows as three gunas","Horcruxes as Inverse Chakras")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Elder Wand: rajas — passion and action","Horcruxes as Inverse Chakras")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Resurrection Stone: tamas — darkness and memory","Horcruxes as Inverse Chakras")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Invisibility Cloak: sattva — harmony","Horcruxes as Inverse Chakras")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Voldemort and Harry as unus-ambo","Horcruxes as Inverse Chakras")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Snape as the alchemical sulfur","Horcruxes as Inverse Chakras")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Dumbledore as the philosopher-mercure","Horcruxes as Inverse Chakras")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Integration over division","Horcruxes as Inverse Chakras")
...
def vis_v10(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Caution: literature is not doctrine","Horcruxes as Inverse Chakras")
...
def vis_v11(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Closing: the alchemy is in the reader","Horcruxes as Inverse Chakras")
...
SCENES = [ Scene("The alchemical structure of Harry Potter","Horcruxes as Inverse Chakras",7.0,"vis_v0",{}), Scene("7 Horcruxes — 7 chakras inverted","Horcruxes as Inverse Chakras",7.0,"vis_v1",{}), Scene("The Deathly Hallows as three gunas","Horcruxes as Inverse Chakras",7.0,"vis_v2",{}), Scene("Elder Wand: rajas — passion and action","Horcruxes as Inverse Chakras",7.0,"vis_v3",{}), Scene("Resurrection Stone: tamas — darkness and memory","Horcruxes as Inverse Chakras",7.0,"vis_v4",{}), Scene("Invisibility Cloak: sattva — harmony","Horcruxes as Inverse Chakras",7.0,"vis_v5",{}), Scene("Voldemort and Harry as unus-ambo","Horcruxes as Inverse Chakras",7.0,"vis_v6",{}), Scene("Snape as the alchemical sulfur","Horcruxes as Inverse Chakras",7.0,"vis_v7",{}), Scene("Dumbledore as the philosopher-mercure","Horcruxes as Inverse Chakras",7.0,"vis_v8",{}), Scene("Integration over division","Horcruxes as Inverse Chakras",7.0,"vis_v9",{}), Scene("Caution: literature is not doctrine","Horcruxes as Inverse Chakras",7.0,"vis_v10",{}), Scene("Closing: the alchemy is in the reader","Horcruxes as Inverse Chakras",7.0,"vis_v11",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"harry_potter_alchemy.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"harry_potter_alchemy","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
