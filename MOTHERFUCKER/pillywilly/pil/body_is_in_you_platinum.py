...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_body_is_in_you")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The claim: the body is inside consciousness","Consciousness as the Container of Experience")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Not the reverse — a radical reversal","Consciousness as the Container of Experience")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The psyche as gestalt of aware energy","Consciousness as the Container of Experience")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The body as a projection of consciousness","Consciousness as the Container of Experience")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Neuroscience from the other direction","Consciousness as the Container of Experience")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Where is consciousness if not in the brain?","Consciousness as the Container of Experience")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Evidence from OBEs","Consciousness as the Container of Experience")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The rubber hand illusion","Consciousness as the Container of Experience")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The constructed self-model","Consciousness as the Container of Experience")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The container and the contained","Consciousness as the Container of Experience")
...
SCENES=[ Scene("The claim: the body is inside consciousness","Consciousness as the Container of Experience",7.0,"vis_v0",{}), Scene("Not the reverse — a radical reversal","Consciousness as the Container of Experience",7.0,"vis_v1",{}), Scene("The psyche as gestalt of aware energy","Consciousness as the Container of Experience",7.0,"vis_v2",{}), Scene("The body as a projection of consciousness","Consciousness as the Container of Experience",7.0,"vis_v3",{}), Scene("Neuroscience from the other direction","Consciousness as the Container of Experience",7.0,"vis_v4",{}), Scene("Where is consciousness if not in the brain?","Consciousness as the Container of Experience",7.0,"vis_v5",{}), Scene("Evidence from OBEs","Consciousness as the Container of Experience",7.0,"vis_v6",{}), Scene("The rubber hand illusion","Consciousness as the Container of Experience",7.0,"vis_v7",{}), Scene("The constructed self-model","Consciousness as the Container of Experience",7.0,"vis_v8",{}), Scene("The container and the contained","Consciousness as the Container of Experience",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"body_is_in_you.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"body_is_in_you","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
