#!/usr/bin/env python3
"""ILLNESS HAS PURPOSE — IT IS ANOTHER MODE OF EXPRESSION
Seth on Why Disease Is Not a Machine Failure"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_illness_has_purpose")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Illness is not a failure of the machine","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"It is another mode of expression","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A means to a desired end","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Success and failure through illness","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The body's language of disturbance","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What happens when we listen","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The placebo effect as evidence","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The mind's control of biology","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Beyond victim blaming","Seth on Why Disease Is Not a Machine Failure")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A new medicine that asks why","Seth on Why Disease Is Not a Machine Failure")
...
SCENES=[ Scene("Illness is not a failure of the machine","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v0",{}), Scene("It is another mode of expression","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v1",{}), Scene("A means to a desired end","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v2",{}), Scene("Success and failure through illness","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v3",{}), Scene("The body's language of disturbance","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v4",{}), Scene("What happens when we listen","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v5",{}), Scene("The placebo effect as evidence","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v6",{}), Scene("The mind's control of biology","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v7",{}), Scene("Beyond victim blaming","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v8",{}), Scene("A new medicine that asks why","Seth on Why Disease Is Not a Machine Failure",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"illness_has_purpose.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"illness_has_purpose","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
