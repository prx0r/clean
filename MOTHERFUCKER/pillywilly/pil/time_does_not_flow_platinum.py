#!/usr/bin/env python3
"""TIME DOES NOT FLOW — YOU MOVE THROUGH A STATIC BLOCK
Physics and Mysticism Agree: All Moments Coexist"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_time_does_not_flow")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The block universe is real","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Special relativity says so","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Seth: past, present, future coexist","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The spacious present","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Time is produced by forgetting","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Sequence is a filter, not a feature","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The science of the block universe","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"If all moments exist, what changes?","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Consciousness as the scanner","Physics and Mysticism Agree: All Moments Coexist")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Death as an illusion","Physics and Mysticism Agree: All Moments Coexist")
...
SCENES=[ Scene("The block universe is real","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v0",{}), Scene("Special relativity says so","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v1",{}), Scene("Seth: past, present, future coexist","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v2",{}), Scene("The spacious present","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v3",{}), Scene("Time is produced by forgetting","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v4",{}), Scene("Sequence is a filter, not a feature","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v5",{}), Scene("The science of the block universe","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v6",{}), Scene("If all moments exist, what changes?","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v7",{}), Scene("Consciousness as the scanner","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v8",{}), Scene("Death as an illusion","Physics and Mysticism Agree: All Moments Coexist",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"time_does_not_flow.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"time_does_not_flow","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
