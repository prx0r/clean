#!/usr/bin/env python3
"""YOUR BODY IS OLDER THAN THE SUN
Stardust, Consciousness, and Cosmic Recycling"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_body_older_than_sun")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Literally true: stellar nucleosynthesis","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Every carbon atom in your body was made in a star","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The star died before the sun was born","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Seth: you are as old as the universe","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Consciousness precedes matter","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The cosmic recycling of matter","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What does it mean to be made of stars?","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Your body is an archive of cosmic history","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The spiritual implication","Stardust, Consciousness, and Cosmic Recycling")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"You are the universe experiencing itself","Stardust, Consciousness, and Cosmic Recycling")
...
SCENES=[ Scene("Literally true: stellar nucleosynthesis","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v0",{}), Scene("Every carbon atom in your body was made in a star","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v1",{}), Scene("The star died before the sun was born","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v2",{}), Scene("Seth: you are as old as the universe","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v3",{}), Scene("Consciousness precedes matter","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v4",{}), Scene("The cosmic recycling of matter","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v5",{}), Scene("What does it mean to be made of stars?","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v6",{}), Scene("Your body is an archive of cosmic history","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v7",{}), Scene("The spiritual implication","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v8",{}), Scene("You are the universe experiencing itself","Stardust, Consciousness, and Cosmic Recycling",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"body_older_than_sun.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"body_older_than_sun","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
