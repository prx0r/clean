...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_lambspring")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The alchemical poem of two fishes","Two Fishes as Ida and Pingala")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"One fish: spirit — one fish: soul","Two Fishes as Ida and Pingala")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"They swim in opposite directions","Two Fishes as Ida and Pingala")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The water is the body","Two Fishes as Ida and Pingala")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Ida and pingala: sun and moon","Two Fishes as Ida and Pingala")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The two serpents of the caduceus","Two Fishes as Ida and Pingala")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"When they meet: transformation","Two Fishes as Ida and Pingala")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The fish become one dragon","Two Fishes as Ida and Pingala")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The union of opposites","Two Fishes as Ida and Pingala")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Kundalini through the central channel","Two Fishes as Ida and Pingala")
...
SCENES = [ Scene("The alchemical poem of two fishes","Two Fishes as Ida and Pingala",7.0,"vis_v0",{}), Scene("One fish: spirit — one fish: soul","Two Fishes as Ida and Pingala",7.0,"vis_v1",{}), Scene("They swim in opposite directions","Two Fishes as Ida and Pingala",7.0,"vis_v2",{}), Scene("The water is the body","Two Fishes as Ida and Pingala",7.0,"vis_v3",{}), Scene("Ida and pingala: sun and moon","Two Fishes as Ida and Pingala",7.0,"vis_v4",{}), Scene("The two serpents of the caduceus","Two Fishes as Ida and Pingala",7.0,"vis_v5",{}), Scene("When they meet: transformation","Two Fishes as Ida and Pingala",7.0,"vis_v6",{}), Scene("The fish become one dragon","Two Fishes as Ida and Pingala",7.0,"vis_v7",{}), Scene("The union of opposites","Two Fishes as Ida and Pingala",7.0,"vis_v8",{}), Scene("Kundalini through the central channel","Two Fishes as Ida and Pingala",7.0,"vis_v9",{}) ]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"lambspring","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
