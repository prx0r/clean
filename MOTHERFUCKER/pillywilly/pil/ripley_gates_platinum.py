...
12 Alchemical Stages as Neural Circuit Activation"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_ripley_gates")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"George Ripley's 12 gates","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 1: Calcination — burning away falsehood","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 2: Solution — dissolving the fixed","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 3: Separation — dividing subtle from gross","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 4: Conjunction — the sacred marriage","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 5: Putrefaction — the dark night","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 6: Congelation — the new form","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 7: Cibation — feeding the stone","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 8: Sublimation — the ascent","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 9: Fermentation — HGA contact","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v10(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gate 10-12: Exaltation, Multiplication, Projection","12 Alchemical Stages as Neural Circuit Activation")
...
def vis_v11(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The 12 gates within","12 Alchemical Stages as Neural Circuit Activation")
...
SCENES = [ Scene("George Ripley's 12 gates","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v0",{}), Scene("Gate 1: Calcination — burning away falsehood","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v1",{}), Scene("Gate 2: Solution — dissolving the fixed","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v2",{}), Scene("Gate 3: Separation — dividing subtle from gross","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v3",{}), Scene("Gate 4: Conjunction — the sacred marriage","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v4",{}), Scene("Gate 5: Putrefaction — the dark night","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v5",{}), Scene("Gate 6: Congelation — the new form","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v6",{}), Scene("Gate 7: Cibation — feeding the stone","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v7",{}), Scene("Gate 8: Sublimation — the ascent","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v8",{}), Scene("Gate 9: Fermentation — HGA contact","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v9",{}), Scene("Gate 10-12: Exaltation, Multiplication, Projection","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v10",{}), Scene("The 12 gates within","12 Alchemical Stages as Neural Circuit Activation",7.0,"vis_v11",{}) ]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"ripley_gates","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
