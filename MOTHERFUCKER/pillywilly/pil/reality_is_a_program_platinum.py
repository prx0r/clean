#!/usr/bin/env python3
"""REALITY IS A PROGRAM — YOUR DNA IS THE PREVIOUS VERSION
The Cassiopaean Simulation Hypothesis"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_reality_is_a_program")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The Cassiopaean claim","The Cassiopaean Simulation Hypothesis")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Perception is part of the illusion","The Cassiopaean Simulation Hypothesis")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"DNA as the previous program","The Cassiopaean Simulation Hypothesis")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The method for maintaining illusions","The Cassiopaean Simulation Hypothesis")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Linear time as a program feature","The Cassiopaean Simulation Hypothesis")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The upcoming system update","The Cassiopaean Simulation Hypothesis")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Free will within the program","The Cassiopaean Simulation Hypothesis")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Who wrote the program?","The Cassiopaean Simulation Hypothesis")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Simulation hypothesis science","The Cassiopaean Simulation Hypothesis")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Knowledge protects","The Cassiopaean Simulation Hypothesis")
...
SCENES=[ Scene("The Cassiopaean claim","The Cassiopaean Simulation Hypothesis",7.0,"vis_v0",{}), Scene("Perception is part of the illusion","The Cassiopaean Simulation Hypothesis",7.0,"vis_v1",{}), Scene("DNA as the previous program","The Cassiopaean Simulation Hypothesis",7.0,"vis_v2",{}), Scene("The method for maintaining illusions","The Cassiopaean Simulation Hypothesis",7.0,"vis_v3",{}), Scene("Linear time as a program feature","The Cassiopaean Simulation Hypothesis",7.0,"vis_v4",{}), Scene("The upcoming system update","The Cassiopaean Simulation Hypothesis",7.0,"vis_v5",{}), Scene("Free will within the program","The Cassiopaean Simulation Hypothesis",7.0,"vis_v6",{}), Scene("Who wrote the program?","The Cassiopaean Simulation Hypothesis",7.0,"vis_v7",{}), Scene("Simulation hypothesis science","The Cassiopaean Simulation Hypothesis",7.0,"vis_v8",{}), Scene("Knowledge protects","The Cassiopaean Simulation Hypothesis",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"reality_is_a_program.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"reality_is_a_program","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
