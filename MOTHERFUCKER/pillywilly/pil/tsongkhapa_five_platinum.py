#!/usr/bin/env python3
"""TSONGKHAPA FIVE STAGES OF COMPLETION
The Tibetan Buddhist Path to Enlightenment
...
FILM THESIS
-----------
A vajra and bell crossed before a mandala
OUTPUT
------
output_tsongkhapa_five/
"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_tsongkhapa_five")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Tsongkhapa the great reformer","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Five stages of the completion stage","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Stage 1: body isolation","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Stage 2: speech isolation","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Stage 3: mind isolation","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Stage 4: the illusory body","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Stage 5: the clear light","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Union of the two truths","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Buddhahood in one lifetime","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Vajrayana shortcut","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v10(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Caution: requires initiation","The Tibetan Buddhist Path to Enlightenment")
...
def vis_v11(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Closing: the path is already complete","The Tibetan Buddhist Path to Enlightenment")
...
SCENES = [ Scene("Tsongkhapa the great reformer","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v0",{}), Scene("Five stages of the completion stage","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v1",{}), Scene("Stage 1: body isolation","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v2",{}), Scene("Stage 2: speech isolation","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v3",{}), Scene("Stage 3: mind isolation","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v4",{}), Scene("Stage 4: the illusory body","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v5",{}), Scene("Stage 5: the clear light","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v6",{}), Scene("Union of the two truths","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v7",{}), Scene("Buddhahood in one lifetime","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v8",{}), Scene("The Vajrayana shortcut","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v9",{}), Scene("Caution: requires initiation","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v10",{}), Scene("Closing: the path is already complete","The Tibetan Buddhist Path to Enlightenment",7.0,"vis_v11",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"tsongkhapa_five.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"tsongkhapa_five","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
