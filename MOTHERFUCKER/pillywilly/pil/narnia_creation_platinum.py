#!/usr/bin/env python3
"""THE CREATION OF NARNIA AS TATTVA DESCENT
Aslan Singing Worlds Into Being"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_narnia_creation")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The Magician's Nephew: creation story","Aslan Singing Worlds Into Being")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Aslan sings Narnia into being","Aslan Singing Worlds Into Being")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The song becomes light","Aslan Singing Worlds Into Being")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The light becomes land","Aslan Singing Worlds Into Being")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Animals awake to consciousness","Aslan Singing Worlds Into Being")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"This is the tattva descent","Aslan Singing Worlds Into Being")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"From sound to light to form","Aslan Singing Worlds Into Being")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The stone table as kula-acala","Aslan Singing Worlds Into Being")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Narnia as a subtle world","Aslan Singing Worlds Into Being")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Creation as music","Aslan Singing Worlds Into Being")
...
SCENES = [ Scene("The Magician's Nephew: creation story","Aslan Singing Worlds Into Being",7.0,"vis_v0",{}), Scene("Aslan sings Narnia into being","Aslan Singing Worlds Into Being",7.0,"vis_v1",{}), Scene("The song becomes light","Aslan Singing Worlds Into Being",7.0,"vis_v2",{}), Scene("The light becomes land","Aslan Singing Worlds Into Being",7.0,"vis_v3",{}), Scene("Animals awake to consciousness","Aslan Singing Worlds Into Being",7.0,"vis_v4",{}), Scene("This is the tattva descent","Aslan Singing Worlds Into Being",7.0,"vis_v5",{}), Scene("From sound to light to form","Aslan Singing Worlds Into Being",7.0,"vis_v6",{}), Scene("The stone table as kula-acala","Aslan Singing Worlds Into Being",7.0,"vis_v7",{}), Scene("Narnia as a subtle world","Aslan Singing Worlds Into Being",7.0,"vis_v8",{}), Scene("Creation as music","Aslan Singing Worlds Into Being",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"narnia_creation.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"narnia_creation","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
