#!/usr/bin/env python3
"""THE UNIVERSE IS A THOUGHT — NOT A THING
Consciousness Precedes Matter — The Hermetic Claim"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_universe_is_thought")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Consciousness before matter","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The universe formed out of what God is","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A divine psychological gestalt","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The error of separating matter from consciousness","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Consciousness materializes itself as matter","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"As above, so below","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The universe as a thought of the Creator","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Implications for science","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Matter as frozen thought","Consciousness Precedes Matter — The Hermetic Claim")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The liberation of idealism","Consciousness Precedes Matter — The Hermetic Claim")
...
SCENES=[ Scene("Consciousness before matter","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v0",{}), Scene("The universe formed out of what God is","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v1",{}), Scene("A divine psychological gestalt","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v2",{}), Scene("The error of separating matter from consciousness","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v3",{}), Scene("Consciousness materializes itself as matter","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v4",{}), Scene("As above, so below","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v5",{}), Scene("The universe as a thought of the Creator","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v6",{}), Scene("Implications for science","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v7",{}), Scene("Matter as frozen thought","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v8",{}), Scene("The liberation of idealism","Consciousness Precedes Matter — The Hermetic Claim",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"universe_is_thought.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"universe_is_thought","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
