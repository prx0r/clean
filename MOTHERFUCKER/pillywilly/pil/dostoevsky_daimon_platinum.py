...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_dostoevsky_daimon")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The Brothers Karamazov: a daimon novel","Sonya as Daimon-Bearer")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Sonya: the daimon in human form","Sonya as Daimon-Bearer")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Grand Inquisitor: false guru","Sonya as Daimon-Bearer")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Raskolnikov: crime and daimonic punishment","Sonya as Daimon-Bearer")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Myshkin as holy fool","Sonya as Daimon-Bearer")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The underground man as anti-daimon","Sonya as Daimon-Bearer")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Dostoevsky's epilepsy: the daimonic illness","Sonya as Daimon-Bearer")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The alchemy of suffering","Sonya as Daimon-Bearer")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Beauty saves the world","Sonya as Daimon-Bearer")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Russian soul vs the daimon","Sonya as Daimon-Bearer")
...
SCENES = [ Scene("The Brothers Karamazov: a daimon novel","Sonya as Daimon-Bearer",7.0,"vis_v0",{}), Scene("Sonya: the daimon in human form","Sonya as Daimon-Bearer",7.0,"vis_v1",{}), Scene("The Grand Inquisitor: false guru","Sonya as Daimon-Bearer",7.0,"vis_v2",{}), Scene("Raskolnikov: crime and daimonic punishment","Sonya as Daimon-Bearer",7.0,"vis_v3",{}), Scene("Myshkin as holy fool","Sonya as Daimon-Bearer",7.0,"vis_v4",{}), Scene("The underground man as anti-daimon","Sonya as Daimon-Bearer",7.0,"vis_v5",{}), Scene("Dostoevsky's epilepsy: the daimonic illness","Sonya as Daimon-Bearer",7.0,"vis_v6",{}), Scene("The alchemy of suffering","Sonya as Daimon-Bearer",7.0,"vis_v7",{}), Scene("Beauty saves the world","Sonya as Daimon-Bearer",7.0,"vis_v8",{}), Scene("The Russian soul vs the daimon","Sonya as Daimon-Bearer",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"dostoevsky_daimon.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"dostoevsky_daimon","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
