#!/usr/bin/env python3
"""THERE IS NO COMPETITION IN NATURE — ONLY COOPERATION
Seth's Value Fulfillment Explains What Darwin Missed"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_nature_is_cooperation")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Cooperation is the foundation","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Not claw and dagger — loving cooperation","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The given gift of life","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Value fulfillment for all species","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Each cell cooperates with every other","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The body as proof of cooperation","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What competitive evolution misses","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Symbiosis in nature","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Competition is a subset of cooperation","Seth's Value Fulfillment Explains What Darwin Missed")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A new foundation for biology","Seth's Value Fulfillment Explains What Darwin Missed")
...
SCENES=[ Scene("Cooperation is the foundation","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v0",{}), Scene("Not claw and dagger — loving cooperation","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v1",{}), Scene("The given gift of life","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v2",{}), Scene("Value fulfillment for all species","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v3",{}), Scene("Each cell cooperates with every other","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v4",{}), Scene("The body as proof of cooperation","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v5",{}), Scene("What competitive evolution misses","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v6",{}), Scene("Symbiosis in nature","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v7",{}), Scene("Competition is a subset of cooperation","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v8",{}), Scene("A new foundation for biology","Seth's Value Fulfillment Explains What Darwin Missed",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"nature_is_cooperation.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"nature_is_cooperation","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
