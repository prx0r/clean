...
The Assembly of Philosophers Debating the Stone"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_turba_philosophorum")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The oldest alchemical text","The Assembly of Philosophers Debating the Stone")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Philosophers debate the stone","The Assembly of Philosophers Debating the Stone")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Pythagoras speaks on the elements","The Assembly of Philosophers Debating the Stone")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Anaxagoras on the one seed","The Assembly of Philosophers Debating the Stone")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Empedocles on love and strife","The Assembly of Philosophers Debating the Stone")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Each philosopher contributes a piece","The Assembly of Philosophers Debating the Stone")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The agreement beneath the disagreement","The Assembly of Philosophers Debating the Stone")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The stone is both one and many","The Assembly of Philosophers Debating the Stone")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The debate is the method","The Assembly of Philosophers Debating the Stone")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Unity through diversity of views","The Assembly of Philosophers Debating the Stone")
...
SCENES = [ Scene("The oldest alchemical text","The Assembly of Philosophers Debating the Stone",7.0,"vis_v0",{}), Scene("Philosophers debate the stone","The Assembly of Philosophers Debating the Stone",7.0,"vis_v1",{}), Scene("Pythagoras speaks on the elements","The Assembly of Philosophers Debating the Stone",7.0,"vis_v2",{}), Scene("Anaxagoras on the one seed","The Assembly of Philosophers Debating the Stone",7.0,"vis_v3",{}), Scene("Empedocles on love and strife","The Assembly of Philosophers Debating the Stone",7.0,"vis_v4",{}), Scene("Each philosopher contributes a piece","The Assembly of Philosophers Debating the Stone",7.0,"vis_v5",{}), Scene("The agreement beneath the disagreement","The Assembly of Philosophers Debating the Stone",7.0,"vis_v6",{}), Scene("The stone is both one and many","The Assembly of Philosophers Debating the Stone",7.0,"vis_v7",{}), Scene("The debate is the method","The Assembly of Philosophers Debating the Stone",7.0,"vis_v8",{}), Scene("Unity through diversity of views","The Assembly of Philosophers Debating the Stone",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"turba_philosophorum.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"turba_philosophorum","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
