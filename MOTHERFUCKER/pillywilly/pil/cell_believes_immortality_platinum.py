#!/usr/bin/env python3
"""EACH CELL BELIEVES IN ITS OWN IMMORTALITY
The Built-in Faith of Every Chromosome"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_cell_believes_immortality")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Seth's claim: each cell believes","The Built-in Faith of Every Chromosome")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Imprinted in every chromosome","The Built-in Faith of Every Chromosome")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A built-in faith pervades every creature","The Built-in Faith of Every Chromosome")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The cell knows it lives beyond death","The Built-in Faith of Every Chromosome")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Innate knowledge of its own inevitability","The Built-in Faith of Every Chromosome")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The magical approach is biological","The Built-in Faith of Every Chromosome")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Cancer as cellular amnesia","The Built-in Faith of Every Chromosome")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Regeneration science and planaria","The Built-in Faith of Every Chromosome")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Placebo as belief-activated healing","The Built-in Faith of Every Chromosome")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What this means for aging","The Built-in Faith of Every Chromosome")
...
def vis_v10(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The evidence from basal cognition","The Built-in Faith of Every Chromosome")
...
def vis_v11(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Do you believe what your cells know?","The Built-in Faith of Every Chromosome")
...
SCENES=[ Scene("Seth's claim: each cell believes","The Built-in Faith of Every Chromosome",7.0,"vis_v0",{}), Scene("Imprinted in every chromosome","The Built-in Faith of Every Chromosome",7.0,"vis_v1",{}), Scene("A built-in faith pervades every creature","The Built-in Faith of Every Chromosome",7.0,"vis_v2",{}), Scene("The cell knows it lives beyond death","The Built-in Faith of Every Chromosome",7.0,"vis_v3",{}), Scene("Innate knowledge of its own inevitability","The Built-in Faith of Every Chromosome",7.0,"vis_v4",{}), Scene("The magical approach is biological","The Built-in Faith of Every Chromosome",7.0,"vis_v5",{}), Scene("Cancer as cellular amnesia","The Built-in Faith of Every Chromosome",7.0,"vis_v6",{}), Scene("Regeneration science and planaria","The Built-in Faith of Every Chromosome",7.0,"vis_v7",{}), Scene("Placebo as belief-activated healing","The Built-in Faith of Every Chromosome",7.0,"vis_v8",{}), Scene("What this means for aging","The Built-in Faith of Every Chromosome",7.0,"vis_v9",{}), Scene("The evidence from basal cognition","The Built-in Faith of Every Chromosome",7.0,"vis_v10",{}), Scene("Do you believe what your cells know?","The Built-in Faith of Every Chromosome",7.0,"vis_v11",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"cell_believes_immortality.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"cell_believes_immortality","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
