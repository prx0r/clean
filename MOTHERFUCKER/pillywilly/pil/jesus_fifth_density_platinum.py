#!/usr/bin/env python3
"""JESUS WAS A 5TH-DENSITY SOUL WITH 1,009 INCARNATIONS
And He Was Also Socrates — The Cassiopaean Claims"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_jesus_fifth_density")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"A 5th-density soul","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What 5th density means","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"1,009 incarnations — including Socrates","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"One soul, multiple lives","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Joshua, Socrates, Jesus — the same","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The descendants alive today","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Why a 5D soul would incarnate","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The purpose of the mission","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Gnostic interpretation","And He Was Also Socrates — The Cassiopaean Claims")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Challenge to orthodox Christianity","And He Was Also Socrates — The Cassiopaean Claims")
...
SCENES=[ Scene("A 5th-density soul","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v0",{}), Scene("What 5th density means","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v1",{}), Scene("1,009 incarnations — including Socrates","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v2",{}), Scene("One soul, multiple lives","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v3",{}), Scene("Joshua, Socrates, Jesus — the same","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v4",{}), Scene("The descendants alive today","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v5",{}), Scene("Why a 5D soul would incarnate","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v6",{}), Scene("The purpose of the mission","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v7",{}), Scene("The Gnostic interpretation","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v8",{}), Scene("Challenge to orthodox Christianity","And He Was Also Socrates — The Cassiopaean Claims",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"jesus_fifth_density.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"jesus_fifth_density","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
