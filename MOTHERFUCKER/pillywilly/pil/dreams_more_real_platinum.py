#!/usr/bin/env python3
"""DREAMS ARE MORE REAL THAN WAKING REALITY
Seth on Dreams as the Source of All Physical Events"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_dreams_more_real")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Dreams are the source — not byproduct","Seth on Dreams as the Source of All Physical Events")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Events from nonphysical properties","Seth on Dreams as the Source of All Physical Events")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The dream state is the source","Seth on Dreams as the Source of All Physical Events")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Significances not cause-effect","Seth on Dreams as the Source of All Physical Events")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The dreaming intellect surpasses computers","Seth on Dreams as the Source of All Physical Events")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Early man dreamed locations","Seth on Dreams as the Source of All Physical Events")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"All inventions began as dreams","Seth on Dreams as the Source of All Physical Events")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The universe dreamed itself into being","Seth on Dreams as the Source of All Physical Events")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Waking is a specialized dream","Seth on Dreams as the Source of All Physical Events")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Living from the dream source","Seth on Dreams as the Source of All Physical Events")
...
SCENES=[ Scene("Dreams are the source — not byproduct","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v0",{}), Scene("Events from nonphysical properties","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v1",{}), Scene("The dream state is the source","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v2",{}), Scene("Significances not cause-effect","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v3",{}), Scene("The dreaming intellect surpasses computers","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v4",{}), Scene("Early man dreamed locations","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v5",{}), Scene("All inventions began as dreams","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v6",{}), Scene("The universe dreamed itself into being","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v7",{}), Scene("Waking is a specialized dream","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v8",{}), Scene("Living from the dream source","Seth on Dreams as the Source of All Physical Events",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"dreams_more_real.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"dreams_more_real","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
