#!/usr/bin/env python3
"""THE WITCH'S TIMES-TABLE DECODES THE UNIVERSE
Goethe's Number Cipher as the 36 Tattvas Progression"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_witchs_times_table")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Goethe hid a tattva map in Faust","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The witch's kitchen scene","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The one-times-table rhyme","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Decoding the number progression","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The 36 tattvas as numbers","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The descent through the pure path","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Goethe's esoteric sources","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"From one to many and back","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The significance of the cipher","Goethe's Number Cipher as the 36 Tattvas Progression")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Numbers as the structure of consciousness","Goethe's Number Cipher as the 36 Tattvas Progression")
...
SCENES=[ Scene("Goethe hid a tattva map in Faust","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v0",{}), Scene("The witch's kitchen scene","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v1",{}), Scene("The one-times-table rhyme","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v2",{}), Scene("Decoding the number progression","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v3",{}), Scene("The 36 tattvas as numbers","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v4",{}), Scene("The descent through the pure path","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v5",{}), Scene("Goethe's esoteric sources","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v6",{}), Scene("From one to many and back","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v7",{}), Scene("The significance of the cipher","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v8",{}), Scene("Numbers as the structure of consciousness","Goethe's Number Cipher as the 36 Tattvas Progression",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"witchs_times_table.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"witchs_times_table","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
