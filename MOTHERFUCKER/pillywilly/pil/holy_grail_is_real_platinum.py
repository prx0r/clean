#!/usr/bin/env python3
"""THE HOLY GRAIL IS REAL — AND IT'S NOT A CUP
Parzival's Question Could Save the World"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_holy_grail_is_real")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The grail is not a cup — it is a state","Parzival's Question Could Save the World")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The wounded Fisher King","Parzival's Question Could Save the World")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The waste land is the world without the question","Parzival's Question Could Save the World")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Whom does the Grail serve?","Parzival's Question Could Save the World")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The question that heals","Parzival's Question Could Save the World")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Parzival's foolishness and redemption","Parzival's Question Could Save the World")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The second chance","Parzival's Question Could Save the World")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The temple of the Grail","Parzival's Question Could Save the World")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Grail king becomes the Grail","Parzival's Question Could Save the World")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"How to ask the question","Parzival's Question Could Save the World")
...
SCENES=[ Scene("The grail is not a cup — it is a state","Parzival's Question Could Save the World",7.0,"vis_v0",{}), Scene("The wounded Fisher King","Parzival's Question Could Save the World",7.0,"vis_v1",{}), Scene("The waste land is the world without the question","Parzival's Question Could Save the World",7.0,"vis_v2",{}), Scene("Whom does the Grail serve?","Parzival's Question Could Save the World",7.0,"vis_v3",{}), Scene("The question that heals","Parzival's Question Could Save the World",7.0,"vis_v4",{}), Scene("Parzival's foolishness and redemption","Parzival's Question Could Save the World",7.0,"vis_v5",{}), Scene("The second chance","Parzival's Question Could Save the World",7.0,"vis_v6",{}), Scene("The temple of the Grail","Parzival's Question Could Save the World",7.0,"vis_v7",{}), Scene("The Grail king becomes the Grail","Parzival's Question Could Save the World",7.0,"vis_v8",{}), Scene("How to ask the question","Parzival's Question Could Save the World",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"holy_grail_is_real.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"holy_grail_is_real","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
