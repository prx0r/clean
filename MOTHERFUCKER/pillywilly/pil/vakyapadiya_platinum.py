#!/usr/bin/env python3
"""THE VAKYAPADIYA AND THE PHILOSOPHY OF LANGUAGE
Sphota Theory — Meaning as a Sudden Flash"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_vakyapadiya")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Bhartrihari's Vakyapadiya","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The sphota theory of meaning","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The word-whole: sentence as primary unit","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Meaning is not built from phonemes","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The three levels of language","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Vaikhari, madhyama, pasyanti","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Language as brahman","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The flash of understanding","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Linguistics meets mysticism","Sphota Theory — Meaning as a Sudden Flash")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The word that creates worlds","Sphota Theory — Meaning as a Sudden Flash")
...
SCENES = [ Scene("Bhartrihari's Vakyapadiya","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v0",{}), Scene("The sphota theory of meaning","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v1",{}), Scene("The word-whole: sentence as primary unit","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v2",{}), Scene("Meaning is not built from phonemes","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v3",{}), Scene("The three levels of language","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v4",{}), Scene("Vaikhari, madhyama, pasyanti","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v5",{}), Scene("Language as brahman","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v6",{}), Scene("The flash of understanding","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v7",{}), Scene("Linguistics meets mysticism","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v8",{}), Scene("The word that creates worlds","Sphota Theory — Meaning as a Sudden Flash",7.0,"vis_v9",{}) ]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"vakyapadiya","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
