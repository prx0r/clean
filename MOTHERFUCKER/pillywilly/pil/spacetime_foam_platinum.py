#!/usr/bin/env python3
"""SPACETIME FOAM AND THE FABRIC OF MAYA
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_spacetime_foam")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"At the Planck scale space is not smooth","Quantum Structure at the Planck Scale")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Quantum foam: constant creation and annihilation","Quantum Structure at the Planck Scale")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Spacetime as maya — the fabric of illusion","Quantum Structure at the Planck Scale")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Virtual particles: something from nothing","Quantum Structure at the Planck Scale")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The holographic principle","Quantum Structure at the Planck Scale")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Planck length: the limit of measurement","Quantum Structure at the Planck Scale")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Black holes as information processors","Quantum Structure at the Planck Scale")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The universe as a quantum computer","Quantum Structure at the Planck Scale")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Maya as the foam of reality","Quantum Structure at the Planck Scale")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Physics meets metaphysics","Quantum Structure at the Planck Scale")
...
SCENES = [ Scene("At the Planck scale space is not smooth","Quantum Structure at the Planck Scale",7.0,"vis_v0",{}), Scene("Quantum foam: constant creation and annihilation","Quantum Structure at the Planck Scale",7.0,"vis_v1",{}), Scene("Spacetime as maya — the fabric of illusion","Quantum Structure at the Planck Scale",7.0,"vis_v2",{}), Scene("Virtual particles: something from nothing","Quantum Structure at the Planck Scale",7.0,"vis_v3",{}), Scene("The holographic principle","Quantum Structure at the Planck Scale",7.0,"vis_v4",{}), Scene("Planck length: the limit of measurement","Quantum Structure at the Planck Scale",7.0,"vis_v5",{}), Scene("Black holes as information processors","Quantum Structure at the Planck Scale",7.0,"vis_v6",{}), Scene("The universe as a quantum computer","Quantum Structure at the Planck Scale",7.0,"vis_v7",{}), Scene("Maya as the foam of reality","Quantum Structure at the Planck Scale",7.0,"vis_v8",{}), Scene("Physics meets metaphysics","Quantum Structure at the Planck Scale",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"spacetime_foam.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"spacetime_foam","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
