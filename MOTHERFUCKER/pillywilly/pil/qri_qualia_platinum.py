...
QRI and the Combinatorial Space of Qualia"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_qri_qualia")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Qualia Research Institute","QRI and the Combinatorial Space of Qualia")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The combinatorial space of experience","QRI and the Combinatorial Space of Qualia")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Qualia as mathematical structures","QRI and the Combinatorial Space of Qualia")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Valence as information geometry","QRI and the Combinatorial Space of Qualia")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The utility of consciousness","QRI and the Combinatorial Space of Qualia")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Measuring the unmeasurable","QRI and the Combinatorial Space of Qualia")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The hard problem of consciousness","QRI and the Combinatorial Space of Qualia")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"QRI's systematic mapping","QRI and the Combinatorial Space of Qualia")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Implications for AI sentience","QRI and the Combinatorial Space of Qualia")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"A science of subjective experience","QRI and the Combinatorial Space of Qualia")
...
SCENES = [ Scene("Qualia Research Institute","QRI and the Combinatorial Space of Qualia",7.0,"vis_v0",{}), Scene("The combinatorial space of experience","QRI and the Combinatorial Space of Qualia",7.0,"vis_v1",{}), Scene("Qualia as mathematical structures","QRI and the Combinatorial Space of Qualia",7.0,"vis_v2",{}), Scene("Valence as information geometry","QRI and the Combinatorial Space of Qualia",7.0,"vis_v3",{}), Scene("The utility of consciousness","QRI and the Combinatorial Space of Qualia",7.0,"vis_v4",{}), Scene("Measuring the unmeasurable","QRI and the Combinatorial Space of Qualia",7.0,"vis_v5",{}), Scene("The hard problem of consciousness","QRI and the Combinatorial Space of Qualia",7.0,"vis_v6",{}), Scene("QRI's systematic mapping","QRI and the Combinatorial Space of Qualia",7.0,"vis_v7",{}), Scene("Implications for AI sentience","QRI and the Combinatorial Space of Qualia",7.0,"vis_v8",{}), Scene("A science of subjective experience","QRI and the Combinatorial Space of Qualia",7.0,"vis_v9",{}) ]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"qri_qualia","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
