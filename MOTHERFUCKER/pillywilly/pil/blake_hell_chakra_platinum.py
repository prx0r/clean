#!/usr/bin/env python3
"""BLAKE'S PRINTING HOUSE IN HELL IS YOUR SPINAL CHAKRA
The Six Chambers as the Six Lower Energy Centers"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_blake_hell_chakra")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Blake's hell is the spine","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Marriage of Heaven and Hell","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Printing House in Hell","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Six chambers = six lower chakras","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The infernal method of printing","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Knowledge through descent","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Energy as eternal delight","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The body as divine vehicle","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The doors of perception","The Six Chambers as the Six Lower Energy Centers")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"If the doors were cleansed, everything would appear as it is","The Six Chambers as the Six Lower Energy Centers")
...
SCENES=[ Scene("Blake's hell is the spine","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v0",{}), Scene("The Marriage of Heaven and Hell","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v1",{}), Scene("The Printing House in Hell","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v2",{}), Scene("Six chambers = six lower chakras","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v3",{}), Scene("The infernal method of printing","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v4",{}), Scene("Knowledge through descent","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v5",{}), Scene("Energy as eternal delight","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v6",{}), Scene("The body as divine vehicle","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v7",{}), Scene("The doors of perception","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v8",{}), Scene("If the doors were cleansed, everything would appear as it is","The Six Chambers as the Six Lower Energy Centers",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"blake_hell_chakra.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"blake_hell_chakra","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
