#!/usr/bin/env python3
"""MARIA PROPHETISSA AND THE THREE-HOUR STONE
Instant Enlightenment in Alchemy"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_maria_prophetissa")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Maria the Jewess: the first alchemist","Instant Enlightenment in Alchemy")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The three-hour whitening","Instant Enlightenment in Alchemy")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"One becomes two, two becomes three","Instant Enlightenment in Alchemy")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The three hours as three stages","Instant Enlightenment in Alchemy")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Azure blue to brilliant white","Instant Enlightenment in Alchemy")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The quick path in alchemy","Instant Enlightenment in Alchemy")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Maria's apparatus: the kerotakis","Instant Enlightenment in Alchemy")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Sudden vs gradual enlightenment","Instant Enlightenment in Alchemy")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Tantric parallel: sambhavopaya","Instant Enlightenment in Alchemy")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Time is not the limiting factor","Instant Enlightenment in Alchemy")
...
SCENES = [ Scene("Maria the Jewess: the first alchemist","Instant Enlightenment in Alchemy",7.0,"vis_v0",{}), Scene("The three-hour whitening","Instant Enlightenment in Alchemy",7.0,"vis_v1",{}), Scene("One becomes two, two becomes three","Instant Enlightenment in Alchemy",7.0,"vis_v2",{}), Scene("The three hours as three stages","Instant Enlightenment in Alchemy",7.0,"vis_v3",{}), Scene("Azure blue to brilliant white","Instant Enlightenment in Alchemy",7.0,"vis_v4",{}), Scene("The quick path in alchemy","Instant Enlightenment in Alchemy",7.0,"vis_v5",{}), Scene("Maria's apparatus: the kerotakis","Instant Enlightenment in Alchemy",7.0,"vis_v6",{}), Scene("Sudden vs gradual enlightenment","Instant Enlightenment in Alchemy",7.0,"vis_v7",{}), Scene("Tantric parallel: sambhavopaya","Instant Enlightenment in Alchemy",7.0,"vis_v8",{}), Scene("Time is not the limiting factor","Instant Enlightenment in Alchemy",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"maria_prophetissa.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"maria_prophetissa","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
