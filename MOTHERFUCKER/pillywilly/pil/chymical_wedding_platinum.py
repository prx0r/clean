...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_chymical_wedding")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The Rosicrucian manifesto","Seven Days of Initiation")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Christian Rosenkreutz receives the invitation","Seven Days of Initiation")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 1: the castle and the gate","Seven Days of Initiation")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 2: the weighing and the marriage","Seven Days of Initiation")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 3: death of the king and queen","Seven Days of Initiation")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 4: the resurrection","Seven Days of Initiation")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 5: the Virgin Venus appears","Seven Days of Initiation")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 6: the judgment and the tower","Seven Days of Initiation")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Day 7: the return and the seal","Seven Days of Initiation")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The initiation is complete","Seven Days of Initiation")
...
def vis_v10(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Caution: allegory or history?","Seven Days of Initiation")
...
def vis_v11(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Closing: you are also invited","Seven Days of Initiation")
...
SCENES = [ Scene("The Rosicrucian manifesto","Seven Days of Initiation",7.0,"vis_v0",{}), Scene("Christian Rosenkreutz receives the invitation","Seven Days of Initiation",7.0,"vis_v1",{}), Scene("Day 1: the castle and the gate","Seven Days of Initiation",7.0,"vis_v2",{}), Scene("Day 2: the weighing and the marriage","Seven Days of Initiation",7.0,"vis_v3",{}), Scene("Day 3: death of the king and queen","Seven Days of Initiation",7.0,"vis_v4",{}), Scene("Day 4: the resurrection","Seven Days of Initiation",7.0,"vis_v5",{}), Scene("Day 5: the Virgin Venus appears","Seven Days of Initiation",7.0,"vis_v6",{}), Scene("Day 6: the judgment and the tower","Seven Days of Initiation",7.0,"vis_v7",{}), Scene("Day 7: the return and the seal","Seven Days of Initiation",7.0,"vis_v8",{}), Scene("The initiation is complete","Seven Days of Initiation",7.0,"vis_v9",{}), Scene("Caution: allegory or history?","Seven Days of Initiation",7.0,"vis_v10",{}), Scene("Closing: you are also invited","Seven Days of Initiation",7.0,"vis_v11",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"chymical_wedding.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"chymical_wedding","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
