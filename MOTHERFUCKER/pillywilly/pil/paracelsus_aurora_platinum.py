#!/usr/bin/env python3
"""PARACELSUS' SECRET FIRE AS PRANA
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_paracelsus_aurora")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Paracelsus: the Luther of medicine","The Aurora of the Philosophers")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The secret fire: not burning but altering","The Aurora of the Philosophers")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Vaporous, digesting, continuous","The Aurora of the Philosophers")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Enclosed within the body","The Aurora of the Philosophers")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The microcosm contains all","The Aurora of the Philosophers")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Archeus: the inner alchemist","The Aurora of the Philosophers")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The aurora: light of the morning","The Aurora of the Philosophers")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Secret fire as pranagni","The Aurora of the Philosophers")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Medicine as alchemy","The Aurora of the Philosophers")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The body as laboratory","The Aurora of the Philosophers")
...
SCENES = [ Scene("Paracelsus: the Luther of medicine","The Aurora of the Philosophers",7.0,"vis_v0",{}), Scene("The secret fire: not burning but altering","The Aurora of the Philosophers",7.0,"vis_v1",{}), Scene("Vaporous, digesting, continuous","The Aurora of the Philosophers",7.0,"vis_v2",{}), Scene("Enclosed within the body","The Aurora of the Philosophers",7.0,"vis_v3",{}), Scene("The microcosm contains all","The Aurora of the Philosophers",7.0,"vis_v4",{}), Scene("Archeus: the inner alchemist","The Aurora of the Philosophers",7.0,"vis_v5",{}), Scene("The aurora: light of the morning","The Aurora of the Philosophers",7.0,"vis_v6",{}), Scene("Secret fire as pranagni","The Aurora of the Philosophers",7.0,"vis_v7",{}), Scene("Medicine as alchemy","The Aurora of the Philosophers",7.0,"vis_v8",{}), Scene("The body as laboratory","The Aurora of the Philosophers",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"paracelsus_aurora.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"paracelsus_aurora","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
