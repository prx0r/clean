#!/usr/bin/env python3
"""THOMAS VAUGHAN: VIRGIN MERCURY AS KUNDALINI
The Alchemist Who Knew the Serpent Power"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_alchemy_vaughan")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"Thomas Vaughan: poet, alchemist, magus","The Alchemist Who Knew the Serpent Power")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Virgin Mercury: the unawakened Shakti","The Alchemist Who Knew the Serpent Power")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Coelum Terrae: heaven within earth","The Alchemist Who Knew the Serpent Power")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The mercury yields only to love, not violence","The Alchemist Who Knew the Serpent Power")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The green lion devouring the sun","The Alchemist Who Knew the Serpent Power")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Vaughan's invisible nature","The Alchemist Who Knew the Serpent Power")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The daimon as intermediator","The Alchemist Who Knew the Serpent Power")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The chemical wedding within the body","The Alchemist Who Knew the Serpent Power")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Vaughan meets Layayoga","The Alchemist Who Knew the Serpent Power")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The philosopher's stone is within","The Alchemist Who Knew the Serpent Power")
...
SCENES = [ Scene("Thomas Vaughan: poet, alchemist, magus","The Alchemist Who Knew the Serpent Power",7.0,"vis_v0",{}), Scene("Virgin Mercury: the unawakened Shakti","The Alchemist Who Knew the Serpent Power",7.0,"vis_v1",{}), Scene("Coelum Terrae: heaven within earth","The Alchemist Who Knew the Serpent Power",7.0,"vis_v2",{}), Scene("The mercury yields only to love, not violence","The Alchemist Who Knew the Serpent Power",7.0,"vis_v3",{}), Scene("The green lion devouring the sun","The Alchemist Who Knew the Serpent Power",7.0,"vis_v4",{}), Scene("Vaughan's invisible nature","The Alchemist Who Knew the Serpent Power",7.0,"vis_v5",{}), Scene("The daimon as intermediator","The Alchemist Who Knew the Serpent Power",7.0,"vis_v6",{}), Scene("The chemical wedding within the body","The Alchemist Who Knew the Serpent Power",7.0,"vis_v7",{}), Scene("Vaughan meets Layayoga","The Alchemist Who Knew the Serpent Power",7.0,"vis_v8",{}), Scene("The philosopher's stone is within","The Alchemist Who Knew the Serpent Power",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"alchemy_vaughan.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"alchemy_vaughan","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
