#!/usr/bin/env python3
"""GRAVITY ORIGINATES FROM THOUGHT
The Cassiopaean Claim About Attraction"""
...
OUTPUT=Path("/mnt/HC_Volume_106427611/goldrender/output_gravity_is_thought")
...
def vis_v0(im,u,t,p):
    ...
    seal(im,"The claim: gravity comes from thought","The Cassiopaean Claim About Attraction")
...
def vis_v1(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The Cassiopaean dialogue","The Cassiopaean Claim About Attraction")
...
def vis_v2(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Gravity as fence vs ground","The Cassiopaean Claim About Attraction")
...
def vis_v3(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The thought center","The Cassiopaean Claim About Attraction")
...
def vis_v4(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"What does it mean for gravity to be mental?","The Cassiopaean Claim About Attraction")
...
def vis_v5(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Relation between mass and attention","The Cassiopaean Claim About Attraction")
...
def vis_v6(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Quantum gravity and consciousness","The Cassiopaean Claim About Attraction")
...
def vis_v7(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"If thoughts have weight","The Cassiopaean Claim About Attraction")
...
def vis_v8(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"Meditation and the gravitational field","The Cassiopaean Claim About Attraction")
...
def vis_v9(im,u,t,p):
    ...
    for j in range(int(8*r)):
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,14,GOLD,int(150*r),11)
    seal(im,"The unification of mind and matter","The Cassiopaean Claim About Attraction")
...
SCENES=[ Scene("The claim: gravity comes from thought","The Cassiopaean Claim About Attraction",7.0,"vis_v0",{}), Scene("The Cassiopaean dialogue","The Cassiopaean Claim About Attraction",7.0,"vis_v1",{}), Scene("Gravity as fence vs ground","The Cassiopaean Claim About Attraction",7.0,"vis_v2",{}), Scene("The thought center","The Cassiopaean Claim About Attraction",7.0,"vis_v3",{}), Scene("What does it mean for gravity to be mental?","The Cassiopaean Claim About Attraction",7.0,"vis_v4",{}), Scene("Relation between mass and attention","The Cassiopaean Claim About Attraction",7.0,"vis_v5",{}), Scene("Quantum gravity and consciousness","The Cassiopaean Claim About Attraction",7.0,"vis_v6",{}), Scene("If thoughts have weight","The Cassiopaean Claim About Attraction",7.0,"vis_v7",{}), Scene("Meditation and the gravitational field","The Cassiopaean Claim About Attraction",7.0,"vis_v8",{}), Scene("The unification of mind and matter","The Cassiopaean Claim About Attraction",7.0,"vis_v9",{}) ]
...
def concat(paths):
    ...
    final=OUTPUT/"gravity_is_thought.mp4"
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"gravity_is_thought","scene_count":len(SCENES),"runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],"scenes":recs},indent=2,ensure_ascii=False),encoding="utf-8"); return p
