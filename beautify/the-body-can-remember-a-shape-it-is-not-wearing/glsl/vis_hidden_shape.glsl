...
void main(){vec2 uv=gl_FragCoord.xy/iResolution,p=aspectUV(uv,iResolution);fragColor=vec4(renderCounterfactualAnatomy(p,uv,0,u,t,u_audioVolume,u_audioBeat),1);}
